...
def Eu_Option_BS_MC(S0: float, r: float, sigma: float, T: int, K: float, M: int, f: callable, seed: int, set_seed: bool) -> float:
...
MC_sim, MC_quantiles = Eu_Option_BS_MC(S0=S0, r=r, sigma=sigma, T=T, K=K, M=M, f=f, seed=seed, set_seed=True)
