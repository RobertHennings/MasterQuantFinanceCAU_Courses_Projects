...
def BS_EuOption_MC_CV(S0: float, r: float, sigma: float, T: int, K: float, M: int, seed: int, set_seed: bool) -> float:
...
# Compare
print(f"The Covariate Variable method yields a value of: {BS_EuOption_MC_CV(S0, r, sigma, T, K, M, seed, set_seed)}\
